...
export default function KochiWorkspacePage() {
  const mapLink = "https://share.google/nXq5ErAyTxi1wRsWX";
  return (
        ...
        <Container>
          <Reveal>
            ...
            <h1 className="mt-4 max-w-3xl font-[family-name:var(--font-display)] text-[clamp(2.5rem,4.5vw,4.5rem)] leading-[1.05] font-bold tracking-tight">
              Kochi <span className="text-brand-deep">Virtual Office</span>
            </h1>
            <p className="text-canvas-fg-secondary mt-6 max-w-xl text-lg">
              Establish a professional business presence in the heart of Ernakulam. Get a premium corporate address, meeting spaces, and comprehensive registration support.
            </p>
          </Reveal>
        </Container>
      </Section>
